...
import com.iiseeuu.helper.entity.FacilityEntity;
import com.iiseeuu.helper.entity.Facilitys;
...
public interface ApiService {
    ...
    //获取订单列表
    @GET("")
    Observable<BaseResp<Orders>> getOrderList(@QueryMap Map<String, String> params);

    //获取用户列表
    @GET("")
    Observable<BaseResp<Users>> getUserList(@Query("access_token") String token, @Query("type") String type, @Query("page") String page, @Query("page_size") String pageSize);

    //获取用户详情
    @GET("")
    Observable<BaseResp<UserEntity>> getUserDetail(@Query("access_token") String token, @Query("id") String id);

    //获取打印机列表
    @GET("")
    Observable<BaseResp<Facilitys>> getPrintList(@QueryMap Map<String, String> params);

    //打印机详情
    @GET("")
    Observable<BaseResp<FacilityEntity>> getPrintDetail(@Query("access_token") String token, @Query("id") String id);
